...
- [x] Launch RA9 (all 3 fixes) and RA10 (collapse + PFSP only) on niro-2
...
## Next Steps
- [x] Push code and launch RA9 (all fixes: collapse=0.05, pfsp, survival=0.03, adaptive_ratio=0.3)
- [x] Launch RA10 (collapse + pfsp only, no adaptive ratio, no survival bonus)
