...
- [x] Launch training Runs V (equal speed) and W (pursuer 95%) with Tier 1+2 fixes
...
### Training Runs V & W Launched
- **Run V**: Equal speed (pursuer=1.0, evader=1.0), smooth curriculum, all Tier 1+2 fixes, seed=47
- **Run W**: Pursuer 95% speed (pursuer=0.95, evader=1.0), same config, seed=47
- Both running in background on local machine
