...
class AMSDRLSelfPlay:
    ...
    def _cold_start(self):
        ...
        _reward_keys = {"w_occlusion", "use_visibility_reward", "visibility_weight", "survival_bonus", "w_obs_approach", "w_vis_pursuer", "timeout_penalty"}
        ...
        if any(v for k, v in reward_params.items() if k != "w_occlusion" and v) or reward_params.get("w_occlusion", 0.0) > 0:
            ...
            rc = RewardComputer(
                ...
                d_max=arena_diag,
                sensing_radius=pe_kwargs.get("sensing_radius"),
                **reward_params,
            )
    ...
    def _build_callbacks(self, role: str, ckpt_mgr: CheckpointManager, phase: int):
        ...
        if role == "pursuer":
            _rk = {"w_occlusion", "use_visibility_reward", "visibility_weight", "survival_bonus", "w_obs_approach", "w_vis_pursuer", "partial_obs_los"}
